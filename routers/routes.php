...
return [
    'GET' => [
        ...
        'titulo/(.+)' => 'TitulosController@QueryOneController',
        'titulosCompletos/(.+)' => 'TitulosController@mostrarTitulosSubtitulos',
        'tituloPadre/(.+)' => 'TitulosController@QueryTituloPadre',
    ...
    'POST' => [
        ...
        'subtitulo' => 'TitulosController@InsertSubtemaController',
    ...
    'PUT' => [
        ...
        'subtitulo/(.+)' => 'TitulosController@UpdateControllerSubtema',
